...
9. 社長が組織図とDB由来の組織階層を表示する
10. 社長がユーザー編集画面で表示名を変更し、ロールを付与・剥奪して監査ログを確認する
11. 一般正社員が組織図を表示でき、ユーザー管理リンクを持たないことを確認する
12. パートが組織図リンクを持たず、直接アクセスでも403になることを確認する
13. BFF allowlist外のBackend APIが404で拒否されることを確認する
...
23. ローカル管理者が送付済メール一覧と本文詳細を表示できることを確認する
24. 一般ユーザーにメール履歴メニューを表示せず、直接APIとURLを403で拒否する
